...
-    Model: Frequency \~ lag_mwdiff + Population + Unemployment Rate

-    Within lustered by State
...
```{r}
#Fixed effects model
fe.state <- plm(formula=Frequency ~ lag_mwdiff + Population + Unemploymentrate,data = opioid_m2, model = "within", index=c("FIPS_Code", "Mon"),effect = "twoways")
